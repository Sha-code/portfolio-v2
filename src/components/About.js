...
const About = () => (
    <div id="about" className="relative bg-gray-100 dark:bg-gray-800 bg-opacity-30 p-4 md:p-10 rounded-xl h-full shadow-sm md:w-10/12 my-12 md:my-32 mx-auto">
        <div className="mt-14 xs:mt-15 bg-gray-50 bg-opacity-20 p-6 rounded-xl shadow-xl md:w-4/5 mx-auto flex flex-col md:flex-row justify-between items-center">
